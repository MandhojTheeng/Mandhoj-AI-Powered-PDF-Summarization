        ...
        <section className="py-16 sm:py-20">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-12">
                    <div className="inline-flex items-center rounded-full px-4 py-1 text-sm bg-rose-50 text-rose-500 ring-1 ring-inset ring-rose-100 mb-4">
                        Simple Process
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
                    ...
                    <div className="relative group">
                        <div className="bg-white/90 backdrop-blur-sm p-6 rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300">
                    ...
                    <div className="relative group">
                        <div className="bg-white/90 backdrop-blur-sm p-6 rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300">
                            <div className="flex items-center justify-center w-12 h-12 bg-rose-50 rounded-xl mb-6">
                    ...
                    <div className="relative group">
                        <div className="bg-white/90 backdrop-blur-sm p-6 rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300">
                            <div className="flex items-center justify-center w-12 h-12 bg-purple-50 rounded-xl mb-6">
                ...
                <div className="mt-16 text-center">
                    <NavLink href="/#pricing">
                        <Button className="bg-rose-500 text-white hover:bg-rose-600 px-8">
                            Try Mandhoj Free
                        </Button>
                    </NavLink>
                </div>
