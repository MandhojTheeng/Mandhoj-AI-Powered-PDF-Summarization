...
//       {/* Glowing badge */}
//       <div className="relative p-[1px] overflow-hidden rounded-full bg-gradient-to-r from-rose-200 via-rose-500 to-rose-800 animate-gradient-x group shadow-lg">
//         <Badge
//           variant="secondary"
...
//             Smart AI-Powered Uploader
//           </span>
//         </Badge>
//       </div>

//       {/* Main heading */}
//       <h1 className="capitalize text-3xl sm:text-4xl font-extrabold tracking-tight text-gray-900">
//         Upload & Enhance
...
//       {/* Subheading */}
//       <p className="mt-2 text-lg sm:text-xl leading-relaxed text-gray-600 max-w-2xl">
